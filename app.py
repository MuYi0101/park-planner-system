...
vertices = {
    ...
    'V3': {'name': '摩天輪',   'Wt': 20, 'Wc': 100, 'We': 2, 'We_sun': 2},
    'V4': {'name': '鬼屋',     'Wt': 25, 'Wc': 120, 'We': 6, 'We_sun': 0},
    'V5': {'name': '漂漂河',   'Wt': 30, 'Wc': 80,  'We': 4, 'We_sun': 4},
    'V6': {'name': '旋轉木馬', 'Wt': 10, 'Wc': 50,  'We': 1, 'We_sun': 2}
}
